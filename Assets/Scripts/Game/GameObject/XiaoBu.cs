...
public class XiaoBu : Enemy
{
    public override List<AnimCallBackEntity> GetCallBacks()
    {
        List<AnimCallBackEntity> res = new List<AnimCallBackEntity>();
        //动作结束回到站立 动作回调
        res.Add(new AnimCallBackEntity("Boss2_Attack1", "FinishedToIdle", 1.0f, AnimEventParamType.Null)); //exitime 1.0
        res.Add(new AnimCallBackEntity("Boss2_Attack2", "FinishedToIdle", 1.0f, AnimEventParamType.Null)); //exitime 1.0
        res.Add(new AnimCallBackEntity("Boss2_Attack3", "FinishedToIdle", 1.0f, AnimEventParamType.Null)); //exitime 1.0
        res.Add(new AnimCallBackEntity("Boss2_Attack4", "FinishedToIdle", 1.0f, AnimEventParamType.Null)); //exitime 1.0
        res.Add(new AnimCallBackEntity("Boss2_BeAttacked", "FinishedToIdle", 1.0f, AnimEventParamType.Null)); //exitime 1.0
        res.Add(new AnimCallBackEntity("Boss2_Up", "FinishedToIdle", 0.8f, AnimEventParamType.Null)); //exitime 0.85 
       //声音回调
       res.Add(new AnimCallBackEntity("Boss2_Attack1", "AttackSound", 0.1f, AnimEventParamType.String, "Boss2_Attack1|1.0"));
        res.Add(new AnimCallBackEntity("Boss2_Attack2", "AttackSound", 0.1f, AnimEventParamType.String, "Boss2_Attack2|1.0"));
        res.Add(new AnimCallBackEntity("Boss2_Attack3", "AttackSound", 0.1f, AnimEventParamType.String, "Boss2_Attack3|1.0"));
        res.Add(new AnimCallBackEntity("Boss2_Attack4", "AttackSound", 0.1f, AnimEventParamType.String, "Boss2_Attack4|1.0"));

        //攻击判定
        BattleCharacter bc = BattleController.Instance.GetBattleCharacter(GetCharacterId());
        res.Add(new AnimCallBackEntity("Boss2_Attack1", "AttackJudge", 0.4f, AnimEventParamType.Int, bc.skill1_id)); //int skill id
        res.Add(new AnimCallBackEntity("Boss2_Attack2", "AttackJudge", 0.4f, AnimEventParamType.Int, bc.skill2_id)); //int skill id
        res.Add(new AnimCallBackEntity("Boss2_Attack3", "AttackParticleCreate", 0.4f, AnimEventParamType.String, 
            bc.skill3_id.ToString()+"|"+ "Boss2_Attack3_Niu")); //int skill id
        res.Add(new AnimCallBackEntity("Boss2_Attack4", "AttackJudge", 0.4f, AnimEventParamType.Int, bc.skill4_id)); //int skill id
        return res;
    }
    ...
    /// 查找距离
    /// </summary>
    private readonly float BASE_SEARCH_DIS = 2f;
    /// <summary>
    /// 重写walk的搜索距离，小于该距离就停止
    /// </summary>
    /// <returns></returns>
    public override float GetSearchDistance()
    {
    ...
    /// 两次攻击的间隔时间
    /// </summary>
    private readonly float ATTACK_INTERVAL = 1F;
    ...
    /// 基础移动速率
    /// </summary>
    private readonly float MOVE_SPEED_BASE = 3.2F;
    ...
    /// 每次移动的时间
    /// </summary>
    private readonly float MOVE_TIME = 5F;
