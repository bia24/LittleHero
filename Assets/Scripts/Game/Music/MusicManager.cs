...
public class MusicManager : Singleton<MusicManager>
{
    ...
    /// </summary>
    private static string AUDIO_RESOURCES_PATH = "Sound";
    /// <summary>
    /// 音乐音量
    /// </summary>
    ...
    public void Play(AudioSource source, string clipType, bool isBreakOther = false, bool isLoop = false, bool isCustomVolume = false, float customVolumeScale = 0.0f)
    {
        //获取音乐名称
        ...
        {
            clip = AssetManager.Instance.LoadObject<AudioClip>(AUDIO_RESOURCES_PATH + "/" + clipName);
            if (clip == null)
            {
        ...
        volume = isCustomVolume == true ? volume * customVolumeScale : volume;
